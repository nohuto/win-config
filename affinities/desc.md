...
> [drivers/kernel | introduction-to-interrupt-service-routines](ttps://learn.microsoft.com/en-us/windows-hardware/drivers/kernel/introduction-to-interrupt-service-routines)  
  ...
  "COMMANDS": {
    "EnableMSI": {
      ...
      "Operations": [
        ...
        { "SubKey": "Affinity Policy", "Value": "DevicePriority", "Operation": "deletevalue" }
      ]
    }
  }
},
