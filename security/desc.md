...
```c
// Disabled (default)
RegSetValue	HKLM\System\CurrentControlSet\Control\Session Manager\Memory Management\ClearPageFileAtShutdown	Type: REG_DWORD, Length: 4, Data: 0

// Enabled
RegSetValue	HKLM\System\CurrentControlSet\Control\Session Manager\Memory Management\ClearPageFileAtShutdown	Type: REG_DWORD, Length: 4, Data: 1
```
